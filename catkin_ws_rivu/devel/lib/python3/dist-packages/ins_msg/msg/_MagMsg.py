...
"""autogenerated by genpy from ins_msg/MagMsg.msg. Do not edit."""
import codecs
import sys
...
class MagMsg(genpy.Message):
  _md5sum = "6bee64c96ada223eec16e97374109c1f"
  _type = "ins_msg/MagMsg"
...
string frame_id
"""
  __slots__ = ['header','utime','mag','msg_cnt']
  _slot_types = ['std_msgs/Header','int64','float32[3]','uint8']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(MagMsg, self).__init__(*args, **kwds)
