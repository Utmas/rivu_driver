...
class OdomMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('pulse_cnt')) {
        this.pulse_cnt = initObj.pulse_cnt
      }
      else {
        this.pulse_cnt = 0.0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [pulse_cnt]
    bufferOffset = _serializer.float32(obj.pulse_cnt, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new OdomMsg(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [utime]
    data.utime = _deserializer.int64(buffer, bufferOffset);
    // Deserialize message field [pulse_cnt]
    data.pulse_cnt = _deserializer.float32(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new OdomMsg(null);
    ...
    if (msg.pulse_cnt !== undefined) {
      resolved.pulse_cnt = msg.pulse_cnt;
    }
    else {
      resolved.pulse_cnt = 0.0
    }
