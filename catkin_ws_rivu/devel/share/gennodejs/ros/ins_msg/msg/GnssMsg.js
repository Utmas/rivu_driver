...
class GnssMsg {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('distance_travelled')) {
        this.distance_travelled = initObj.distance_travelled
      }
      else {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [distance_travelled]
    bufferOffset = _serializer.float64(obj.distance_travelled, buffer, bufferOffset);
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [distance_travelled]
    data.distance_travelled = _deserializer.float64(buffer, bufferOffset);
  ...
  static Resolve(msg) {
    ...
    const resolved = new GnssMsg(null);
    ...
    if (msg.distance_travelled !== undefined) {
      resolved.distance_travelled = msg.distance_travelled;
    }
    else {
      resolved.distance_travelled = 0.0
    }
