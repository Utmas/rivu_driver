...
(cl:defmethod cl:initialize-instance :after ((m <InsMsg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'InsMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ins_msg-msg:<InsMsg> is deprecated: use ins_msg-msg:InsMsg instead.")))
...
(cl:defmethod utime-val ((m <InsMsg>))
...
(cl:defmethod longitude-val ((m <InsMsg>))
...
(cl:defmethod latitude-val ((m <InsMsg>))
...
(cl:defmethod height-val ((m <InsMsg>))
...
(cl:defmethod roll-val ((m <InsMsg>))
...
(cl:defmethod pitch-val ((m <InsMsg>))
...
(cl:defmethod yaw-val ((m <InsMsg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ins_msg-msg:yaw-val is deprecated.  Use ins_msg-msg:yaw instead.")
  (yaw m))

(cl:ensure-generic-function 'msg_cnt-val :lambda-list '(m))
(cl:defmethod msg_cnt-val ((m <InsMsg>))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<InsMsg>)))
  ...
  "c7eaa178457b9b44717ef05843690a4a")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'InsMsg)))
  "Returns md5sum for a message object of type 'InsMsg"
  "c7eaa178457b9b44717ef05843690a4a")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<InsMsg>)))
  ...
  (cl:format cl:nil "Header header~%~%int64 utime~%~%float64 longitude~%float64 latitude~%float64 height~%float64 ve~%float64 vn~%float64 vu~%float64 roll~%float64 pitch~%float64 yaw~%uint8 msg_cnt~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'InsMsg)))
  "Returns full string definition for message of type 'InsMsg"
  (cl:format cl:nil "Header header~%~%int64 utime~%~%float64 longitude~%float64 latitude~%float64 height~%float64 ve~%float64 vn~%float64 vu~%float64 roll~%float64 pitch~%float64 yaw~%uint8 msg_cnt~%~%~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%~%"))
