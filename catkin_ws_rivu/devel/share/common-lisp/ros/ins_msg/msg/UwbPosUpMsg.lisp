...
(cl:defclass <UwbPosUpMsg> (roslisp-msg-protocol:ros-message)
  ((header
    :reader header
    :initarg :header
...
(cl:defclass UwbPosUpMsg (<UwbPosUpMsg>)
  ())

(cl:defmethod cl:initialize-instance :after ((m <UwbPosUpMsg>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'UwbPosUpMsg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ins_msg-msg:<UwbPosUpMsg> is deprecated: use ins_msg-msg:UwbPosUpMsg instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <UwbPosUpMsg>))
...
(cl:defmethod utime-val ((m <UwbPosUpMsg>))
...
(cl:defmethod uwb_poss-val ((m <UwbPosUpMsg>))
...
(cl:defmethod status-val ((m <UwbPosUpMsg>))
...
(cl:defmethod msg_cnt-val ((m <UwbPosUpMsg>))
  ...
  (msg_cnt m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <UwbPosUpMsg>) ostream)
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <UwbPosUpMsg>) istream)
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<UwbPosUpMsg>)))
  "Returns string type for a message object of type '<UwbPosUpMsg>"
  "ins_msg/UwbPosUpMsg")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'UwbPosUpMsg)))
  "Returns string type for a message object of type 'UwbPosUpMsg"
  "ins_msg/UwbPosUpMsg")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<UwbPosUpMsg>)))
  "Returns md5sum for a message object of type '<UwbPosUpMsg>"
  "005914774339b077b09ea7254ee22520")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'UwbPosUpMsg)))
  "Returns md5sum for a message object of type 'UwbPosUpMsg"
  "005914774339b077b09ea7254ee22520")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<UwbPosUpMsg>)))
  "Returns full string definition for message of type '<UwbPosUpMsg>"
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'UwbPosUpMsg)))
  "Returns full string definition for message of type 'UwbPosUpMsg"
  (cl:format cl:nil "Header header~%~%int64       utime~%~%UwbPos uwb_poss~%~%uint8       status~%uint8       msg_cnt~%~%================================================================================~%MSG: std_msgs/Header~%# Standard metadata for higher-level stamped data types.~%# This is generally used to communicate timestamped data ~%# in a particular coordinate frame.~%# ~%# sequence ID: consecutively increasing ID ~%uint32 seq~%#Two-integer timestamp that is expressed as:~%# * stamp.sec: seconds (stamp_secs) since epoch (in Python the variable is called 'secs')~%# * stamp.nsec: nanoseconds since stamp_secs (in Python the variable is called 'nsecs')~%# time-handling sugar is provided by the client library~%time stamp~%#Frame this data is associated with~%string frame_id~%~%================================================================================~%MSG: ins_msg/UwbPos~%uint32     dev_id~%float32[3] pos~%float32[6] cov~%~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <UwbPosUpMsg>))
  (cl:+ 0
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <UwbPosUpMsg>))
